...
@section('content')
          ...
          <div class="col-md-12 col-lg-10">
            <div class="post-entry text-center">
              ...
              <div class="post-meta align-items-center text-center">
                <figure class="profile author-figure mb-0 mr-3 d-inline-block"><img src="@if($post->user->image){{ asset($post->user->image) }}@else{{ asset('website/images/user.png')}}@endif" alt="Image" class="img-fluid"></figure>
          ...
          <div class="col-md-12 col-lg-4 sidebar">
            ...
            <div class="sidebar-box">
              ...
              <ul class="categories">
                ...
                <li><a href="{{ route('website.category', ['slug' => $category->slug]) }}">{{ $category->name }}</a>
    ...
    <script>
        ...
        s.src = 'https://example-com-7vurivmwrt.disqus.com/embed.js';
        s.setAttribute('data-timestamp', +new Date());
        (d.head || d.body).appendChild(s);
        })();
    </script>
    <noscript>Please enable JavaScript to view the <a href="https://disqus.com/?ref_noscript">comments powered by Disqus.</a></noscript>
   // <script id="dsq-count-scr" src="//example-com-7vurivmwrt.disqus.com/count.js" async></script>
   @endsection