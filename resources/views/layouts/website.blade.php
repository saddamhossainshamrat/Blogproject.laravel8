    ...
    <div class="site-footer">
      <div class="container">
        <div class="row mb-5">
          ...
          @if($setting->email)<a href="{{ $setting->email }}"><span class="icon-envelope p-2"></span></a>@endif
              </p>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-12 text-center">
            <p>
              ...
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              <div class="mb-0">Developed By Saddam on <a href="">Laravel Blog Using Laravel 8</a> </div>
              </p>
          </div>
        </div>
      </div>
